                                        ...
                                        await Ques.findById(res._id)
                                            ...
                                            .then((ques)=>{
                                                ...
                                                if(grading(answer,res.response)){
                                                    ...
                                                    res.iscorrect = true;
                                                    result.totalscore = result.totalscore + res.marks_correct;
                                                }else{
                                                    res.user_score = res.marks_wrong;
                                                    result.totalscore = result.totalscore + res.marks_wrong;
                                                }
                                            })
                                            .catch((err)=>{
                                                console.log(err);
                                  ...
                                  .then(()=>{
                                    result.sections.map((sec,i)=>{
                                        ...
                                        for(i=sec.startindex;i<=sec.endindex;i++){
                                            secscore = secscore + result.user_response[i].user_score;
                                            if(result.user_response[i].answered||result.user_response[i].markedanswered) secattempt++;
