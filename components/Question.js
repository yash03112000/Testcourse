            ...
            <div className={classes.sec7}>
                <div style={{margin:10}}>
                    ...
                    <RadioGroup aria-label="quiz" name="quiz" style={{color:'black',padding:8}}>
                        {ques.option_1.valid?<FormControlLabel value={ques.option_1._id} control={<Radio checked={a[ques.option_1._id]} onChange={(e)=>{a[op1]=e.target.checked;fun(op1,e.target.checked)}}/>} label={parse(ques.option_1.content)} />:<></>}
                        {ques.option_2.valid?<FormControlLabel value={ques.option_2._id} control={<Radio checked={a[ques.option_2._id]} onChange={(e)=>{a[op2]=e.target.checked;fun(op2,e.target.checked)}}/>} label={parse(ques.option_2.content)} />:<></>}
                        {ques.option_3.valid?<FormControlLabel value={ques.option_3._id} control={<Radio checked={a[ques.option_3._id]} onChange={(e)=>{a[op3]=e.target.checked;fun(op3,e.target.checked)}}/>} label={parse(ques.option_3.content)} />:<></>}
                        {ques.option_4.valid?<FormControlLabel value={ques.option_4._id} control={<Radio checked={a[ques.option_4._id]} onChange={(e)=>{a[op4]=e.target.checked;fun(op4,e.target.checked)}}/>} label={parse(ques.option_4.content)} />:<></>}
