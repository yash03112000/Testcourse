						...
						>
							{ques.option_1.valid ? (
								<FormControlLabel
									...
									control={
										<Radio
											checked={a[ques.option_1._id]}
											onChange={(e) => {
												a[op1] = e.target.checked;
												fun(op1, e.target.checked);
											}}
										/>
									}
							...
							{ques.option_2.valid ? (
								<FormControlLabel
									...
									control={
										<Radio
											checked={a[ques.option_2._id]}
											onChange={(e) => {
												a[op2] = e.target.checked;
												fun(op2, e.target.checked);
											}}
										/>
									}
							...
							{ques.option_3.valid ? (
								<FormControlLabel
									...
									control={
										<Radio
											checked={a[ques.option_3._id]}
											onChange={(e) => {
												a[op3] = e.target.checked;
												fun(op3, e.target.checked);
											}}
										/>
									}
							...
							{ques.option_4.valid ? (
								<FormControlLabel
									...
									control={
										<Radio
											checked={a[ques.option_4._id]}
											onChange={(e) => {
												a[op4] = e.target.checked;
												fun(op4, e.target.checked);
											}}
										/>
									}
					...
					<div className={classes.sec4}>
						<div>
							<Typography
								...
								variant="subtitle1"
								gutterBottom
								style={{ color: 'red', padding: 8, margin: 5 }}
							>
